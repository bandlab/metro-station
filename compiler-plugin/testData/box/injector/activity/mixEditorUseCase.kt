...
@ContributesInjector(
    scope = MixEditorComponentScope::class,
...
fun box(): String {
    ...
    val graph = meGraph.asContribution<MixEditorActivity.FeatureExtension.Factory>().create(meActivity)
    graph.injector.injectMembers(meActivity)
