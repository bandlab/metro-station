 ...
 * `FeatureServiceProvider` is generated by [MetroStationFir] (which registers a predicate for
 * `@MetroStation`), so Metro's in-compilation discovery doesn't see it.
 */
public class MetroStationContributionExtension(private val session: FirSession) :
