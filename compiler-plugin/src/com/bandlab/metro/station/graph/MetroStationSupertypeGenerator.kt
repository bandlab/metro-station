...
/**
 * If a feature is annotated with @MetroStation, we extend `HasServiceProvider` for Activities and Pages.
 */
public class MetroStationSupertypeGenerator(session: FirSession) : FirSupertypeGenerationExtension(session) {

    override fun needTransformSupertypes(declaration: FirClassLikeDeclaration): Boolean {
        return declaration.getAnnotationByClassId(Ids.metroStation, session) != null
    }
