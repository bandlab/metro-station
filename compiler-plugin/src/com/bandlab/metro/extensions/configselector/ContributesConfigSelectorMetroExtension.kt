 ...
 */
public class ContributesConfigSelectorMetroExtension(private val session: FirSession) : MetroContributionExtension {
    ...
    public class Factory : MetroContributionExtension.Factory {
        override fun create(
            ...
            return ContributesConfigSelectorMetroExtension(session)
        }
    }
}
